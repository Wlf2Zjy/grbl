...
#define CMD_OPEN_AIR_FAN 0xA2
#define CMD_CLOSE_AIR_FAN 0xA3
#define CMD_OPEN_LIGHT 0xA4
#define CMD_CLOSE_LIGHT 0xA5
#define CMD_OPEN_CAMERA 0xA6
#define CMD_CLOSE_CAMERA 0xA7
#define CMD_OPEN_LEFT_FAN 0xA8
#define CMD_OPEN_RIGHT_FAN 0xAA
#define CMD_CLOSE_SPINDLE_FAN 0xA9
#define CMD_OPEN_SUCTION_CUP 0xAB
#define CMD_CLOSE_SUCTION_CUP 0xAC
#define CMD_OPEN_SPRAY 0xAD
#define CMD_CLOSE_SPRAY 0xAE
#define CMD_OPEN_LEFT_WATER 0xB0
#define CMD_CLOSE_LEFT_WATER 0xB1
#define CMD_OPEN_RIGHT_WATER 0xB2
#define CMD_CLOSE_RIGHT_WATER 0xB3
#define CMD_OPEN_OUTLINE 0xB4
...
// 使用探针校准
// #define USE_TEST_PROBE // 默认启用。注释以禁用。
...
#define ARC_ANGULAR_TRAVEL_EPSILON 5E-6 // 浮点（弧度）

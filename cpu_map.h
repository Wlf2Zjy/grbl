...
#define CONTROL_MASK ((1 << DRAWER_DETECT_BIT) | (1 << CONTROL_SAFETY_DOOR_BIT) | (1 << X_ALARM_BIT) | (1 << Y_ALARM_BIT) | (1 << Z_ALARM_BIT) | (1 << STOP_ALARM_BIT))
// #define CONTROL_MASK  ((1 << CONTROL_SAFETY_DOOR_BIT) | (1 << X_ALARM_BIT) | (1 << Y_ALARM_BIT) | (1 << Z_ALARM_BIT) | (1 << STOP_ALARM_BIT))
// #define CONTROL_MASK  ((1 << CONTROL_SAFETY_DOOR_BIT) | (1 << STOP_ALARM_BIT))
// 定义探针开关输入引脚。
